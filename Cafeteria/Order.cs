namespace Cafeteria
{
    public class Order : Menu
    {
        ...
        public void DisplayOrderMessage (int coffeeNumber, int cupNumber)
        {
            ...
            {
                var regularCoffee = new RegularCoffee(GetCoffeNameFromInput(coffeeNumber, cupNumber));
            ...
            {
                var largeCoffee = new LargeCoffee(GetCoffeNameFromInput(coffeeNumber, cupNumber));
